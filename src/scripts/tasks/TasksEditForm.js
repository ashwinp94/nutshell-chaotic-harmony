...
//   // The form will contain input fields with existing values from the API
//   // The user can edit the the values in the task input fields by clicking on the taskName.
//   // An event listener on the taskName will handle taking the new values entered by
//   // the user and calling the API to update the data.
//   createAndAppendForm (articleId, taskObjToEdit) {

//     // Building the edit form with fields for the name, dueDate, and
//     // complete checkbox. Only the taskName field can be edited.
