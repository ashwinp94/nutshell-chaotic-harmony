...
const TasksCreateObject = {
  ...
  let foodExp = document.createElement("span")
  foodExp.textContent = foodObject.expiration

  let foodType = document.createElement("span")
  foodType.textContent = foodObject.type

  taskH4.appendChild(taskName)
  taskH4.appendChild(foodExp)
  taskH4.appendChild(foodType)
